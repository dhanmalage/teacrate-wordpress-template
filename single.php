    ...
    <div class="row-fluid">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 no-padding-right">
            <div class="inner-page-checklist-wrapper">
				...
				<div class="under-enquire-button">
					<a href="https://www.rentacrate.co.uk/?utm_source=Teacrate.com&utm_medium=Button&utm_campaign=Home%20Moves%20Page" target="_blank">One Off Move</a>
				</div>
...
<div class="container">
    <div class="row-fluid planting-services">
        ...
        <div class="col-xs-12 col-sm-4">
			...
			<?php if( have_rows('tech_info_list') ): ?>
				<div class="tech-info-list tech-info-list-item">
					<span class="tech-info-title">Technical Info</span>
					<ul>
						<?php							
							while ( have_rows('tech_info_list') ) : the_row();
								?>
